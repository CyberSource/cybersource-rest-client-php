<?php
/**
 * V2payoutsMerchantInformationTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * V2payoutsMerchantInformationTest Class Doc Comment
 *
 * @category    Class */
// * @description V2payoutsMerchantInformation
/**
 * @package     CyberSource
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2payoutsMerchantInformationTest extends \PHPUnit_Framework_TestCase
{
     ...
     */
    public function testV2payoutsMerchantInformation()
    {
    }
