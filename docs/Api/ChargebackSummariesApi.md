...
> \CyberSource\Model\ReportingV3ChargebackSummariesGet200Response getChargebackSummaries($startTime, $endTime, $organizationId)
...
$api_instance = new CyberSource\Api\ChargebackSummariesApi();
...
try {
    $result = $api_instance->getChargebackSummaries($startTime, $endTime, $organizationId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling ChargebackSummariesApi->getChargebackSummaries: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CyberSource\Model\ReportingV3ChargebackSummariesGet200Response**](../Model/ReportingV3ChargebackSummariesGet200Response.md)
