...
# **getRetrievalDetails**
> \CyberSource\Model\ReportingV3RetrievalDetailsGet200Response getRetrievalDetails($startTime, $endTime, $organizationId)
...
$api_instance = new CyberSource\Api\RetrievalDetailsApi();
...
try {
    $result = $api_instance->getRetrievalDetails($startTime, $endTime, $organizationId);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling RetrievalDetailsApi->getRetrievalDetails: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
[**\CyberSource\Model\ReportingV3RetrievalDetailsGet200Response**](../Model/ReportingV3RetrievalDetailsGet200Response.md)
