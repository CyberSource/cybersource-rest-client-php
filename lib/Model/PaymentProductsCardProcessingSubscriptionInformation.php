...
/**
 * PaymentProductsCardProcessingSubscriptionInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentProductsCardProcessingSubscriptionInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentProducts_cardProcessing_subscriptionInformation';
    ...
    protected static $swaggerTypes = [
        ...
        'features' => 'map[string,\CyberSource\Model\PaymentProductsCardProcessingSubscriptionInformationFeatures]'
    ];
    ...
    /**
     * Gets features
     * @return map[string,\CyberSource\Model\PaymentProductsCardProcessingSubscriptionInformationFeatures]
     */
    ...
    /**
     * Sets features
     * @param map[string,\CyberSource\Model\PaymentProductsCardProcessingSubscriptionInformationFeatures] $features This is a map. The allowed keys are below. Value should be an object containing a sole boolean property - enabled. <table>    <tr>       <td>cardPresent</td>    </tr>    <tr>       <td>cardNotPresent</td>    </tr> </table>
     * @return $this
     */
