...
class Ptsv2payoutsProcessingInformation implements ArrayAccess
{
     ...
     * @param string $commerceIndicator Type of transaction.  Value for an OCT transaction: - `internet`  For details, see the `e_commerce_indicator` field description in [Payouts Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/payouts_SCMP/html/wwhelp/wwhimpl/js/html/wwhelp.htm)
     * @return $this
     */
