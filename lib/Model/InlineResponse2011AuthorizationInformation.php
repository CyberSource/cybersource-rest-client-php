...
/**
 * InlineResponse2011AuthorizationInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2011AuthorizationInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_1_authorizationInformation';
    ...
    public function setApprovalCode($approvalCode)
    {
        if (!is_null($approvalCode) && (strlen($approvalCode) > 6)) {
            throw new \InvalidArgumentException('invalid length for $approvalCode when calling InlineResponse2011AuthorizationInformation., must be smaller than or equal to 6.');
        }
    ...
    public function setReasonCode($reasonCode)
    {
        if (!is_null($reasonCode) && (strlen($reasonCode) > 50)) {
            throw new \InvalidArgumentException('invalid length for $reasonCode when calling InlineResponse2011AuthorizationInformation., must be smaller than or equal to 50.');
        }
