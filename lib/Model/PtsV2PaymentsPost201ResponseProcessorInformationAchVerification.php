...
class PtsV2PaymentsPost201ResponseProcessorInformationAchVerification implements ArrayAccess
{
    ...
    /**
     * Sets resultCode
     * @param string $resultCode Results from the ACH verification service, which is described in \"ACH Verification,\" page 25. For the possible values, see Appendix H, \"Verification Codes,\" on page 91.
     * @return $this
     */
    ...
    /**
     * Sets resultCodeRaw
     * @param string $resultCodeRaw Raw results from the ACH verification service, which is described in \"ACH Verification,\" page 25. For the possible values, see Appendix H, \"Verification Codes,\" on page 91.
     * @return $this
     */
