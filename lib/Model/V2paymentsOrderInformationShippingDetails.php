...
/**
 * V2paymentsOrderInformationShippingDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsOrderInformationShippingDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2payments_orderInformation_shippingDetails';
    ...
    public function setShippingMethod($shippingMethod)
    {
        if (!is_null($shippingMethod) && (strlen($shippingMethod) > 10)) {
            throw new \InvalidArgumentException('invalid length for $shippingMethod when calling V2paymentsOrderInformationShippingDetails., must be smaller than or equal to 10.');
        }
    ...
    public function setShipFromPostalCode($shipFromPostalCode)
    {
        if (!is_null($shipFromPostalCode) && (strlen($shipFromPostalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $shipFromPostalCode when calling V2paymentsOrderInformationShippingDetails., must be smaller than or equal to 10.');
        }
