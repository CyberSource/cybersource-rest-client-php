...
class Ptsv2paymentsidrefundsPaymentInformationPaymentType implements ArrayAccess
{
    ...
    /**
     * Sets name
     * @param string $name A Payment Type is an agreed means for a payee to receive legal tender from a payer. The way one pays for a commercial financial transaction. Examples: Card, Bank Transfer, Digital, Direct Debit. Possible values: - `CARD` (use this for a PIN debit transaction) - `CHECK` (use this for eCheck payment and this is equivalent to invoke ics_ecp_debit or ics_ecp_credit service)
     * @return $this
     */
