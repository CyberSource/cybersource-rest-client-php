...
/**
 * TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsV1InstrumentIdentifiersPaymentInstrumentsGet200Response_billTo';
    ...
    public function setFirstName($firstName)
    {
        if (!is_null($firstName) && (strlen($firstName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $firstName when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setLastName($lastName)
    {
        if (!is_null($lastName) && (strlen($lastName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $lastName when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setCompany($company)
    {
        if (!is_null($company) && (strlen($company) > 60)) {
            throw new \InvalidArgumentException('invalid length for $company when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAddress1($address1)
    {
        if (!is_null($address1) && (strlen($address1) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address1 when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setAddress2($address2)
    {
        if (!is_null($address2) && (strlen($address2) > 60)) {
            throw new \InvalidArgumentException('invalid length for $address2 when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 50)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 50.');
        }
    ...
    public function setAdministrativeArea($administrativeArea)
    {
        if (!is_null($administrativeArea) && (strlen($administrativeArea) > 20)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 20.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if (!is_null($postalCode) && (strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 10.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 3.');
        }
        if (!is_null($country) && (strlen($country) < 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be bigger than or equal to 2.');
        }
    ...
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 320)) {
            throw new \InvalidArgumentException('invalid length for $email when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 320.');
        }
    ...
    public function setPhoneNumber($phoneNumber)
    {
        if (!is_null($phoneNumber) && (strlen($phoneNumber) > 32)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be smaller than or equal to 32.');
        }
        if (!is_null($phoneNumber) && (strlen($phoneNumber) < 6)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBillTo., must be bigger than or equal to 6.');
        }
