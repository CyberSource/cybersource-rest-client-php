...
class InlineResponse2005 implements ArrayAccess
{
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse2005., must be smaller than or equal to 26.');
        }
    ...
    public function setReconciliationId($reconciliationId)
    {
        if (!is_null($reconciliationId) && (strlen($reconciliationId) > 60)) {
            throw new \InvalidArgumentException('invalid length for $reconciliationId when calling InlineResponse2005., must be smaller than or equal to 60.');
        }
