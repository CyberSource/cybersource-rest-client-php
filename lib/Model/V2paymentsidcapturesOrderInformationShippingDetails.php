...
/**
 * V2paymentsidcapturesOrderInformationShippingDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesOrderInformationShippingDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_orderInformation_shippingDetails';
    ...
    public function setShipFromPostalCode($shipFromPostalCode)
    {
        if (!is_null($shipFromPostalCode) && (strlen($shipFromPostalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $shipFromPostalCode when calling V2paymentsidcapturesOrderInformationShippingDetails., must be smaller than or equal to 10.');
        }
