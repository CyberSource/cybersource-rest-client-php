...
/**
 * V2paymentsidcapturesProcessingInformationCaptureOptions Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesProcessingInformationCaptureOptions implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_processingInformation_captureOptions';
    ...
    public function setCaptureSequenceNumber($captureSequenceNumber)
    {
        ...
        if (!is_null($captureSequenceNumber) && ($captureSequenceNumber > 99)) {
            throw new \InvalidArgumentException('invalid value for $captureSequenceNumber when calling V2paymentsidcapturesProcessingInformationCaptureOptions., must be smaller than or equal to 99.');
        }
        if (!is_null($captureSequenceNumber) && ($captureSequenceNumber < 1)) {
            throw new \InvalidArgumentException('invalid value for $captureSequenceNumber when calling V2paymentsidcapturesProcessingInformationCaptureOptions., must be bigger than or equal to 1.');
        }
    ...
    public function setTotalCaptureCount($totalCaptureCount)
    {
        ...
        if (!is_null($totalCaptureCount) && ($totalCaptureCount > 99)) {
            throw new \InvalidArgumentException('invalid value for $totalCaptureCount when calling V2paymentsidcapturesProcessingInformationCaptureOptions., must be smaller than or equal to 99.');
        }
        if (!is_null($totalCaptureCount) && ($totalCaptureCount < 1)) {
            throw new \InvalidArgumentException('invalid value for $totalCaptureCount when calling V2paymentsidcapturesProcessingInformationCaptureOptions., must be bigger than or equal to 1.');
        }
