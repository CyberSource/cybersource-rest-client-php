...
class V2paymentsOrderInformationBillTo implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2payments_orderInformation_billTo';
    ...
    /**
     * Sets middleName
     * @param string $middleName Customerâ€™s middle name.
     * @return $this
     */
    public function setMiddleName($middleName)
    {
        if (!is_null($middleName) && (strlen($middleName) > 60)) {
            throw new \InvalidArgumentException('invalid length for $middleName when calling V2paymentsOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets nameSuffix
     * @param string $nameSuffix Customerâ€™s name suffix.
     * @return $this
     */
    public function setNameSuffix($nameSuffix)
    {
        if (!is_null($nameSuffix) && (strlen($nameSuffix) > 60)) {
            throw new \InvalidArgumentException('invalid length for $nameSuffix when calling V2paymentsOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling V2paymentsOrderInformationBillTo., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Sets district
     * @param string $district Customerâ€™s neighborhood, community, or region (a barrio in Brazil) within the city or municipality. This field is available only on **Cielo**.
     * @return $this
     */
