...
class Vasv2taxOrderInformationOrderOrigin implements ArrayAccess
{
    ...
    public function setLocality($locality)
    {
        if (!is_null($locality) && (strlen($locality) > 50)) {
            throw new \InvalidArgumentException('invalid length for $locality when calling Vasv2taxOrderInformationOrderOrigin., must be smaller than or equal to 50.');
        }
    ...
    public function setAdministrativeArea($administrativeArea)
    {
        if (!is_null($administrativeArea) && (strlen($administrativeArea) > 2)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling Vasv2taxOrderInformationOrderOrigin., must be smaller than or equal to 2.');
        }
    ...
    public function setPostalCode($postalCode)
    {
        if (!is_null($postalCode) && (strlen($postalCode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling Vasv2taxOrderInformationOrderOrigin., must be smaller than or equal to 10.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Vasv2taxOrderInformationOrderOrigin., must be smaller than or equal to 2.');
        }
