...
/**
 * TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsV1InstrumentIdentifiersPaymentInstrumentsGet200Response_card';
    ...
    public function setExpirationMonth($expirationMonth)
    {
        if (!is_null($expirationMonth) && (strlen($expirationMonth) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be smaller than or equal to 2.');
        }
        if (!is_null($expirationMonth) && (strlen($expirationMonth) < 2)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be bigger than or equal to 2.');
        }
    ...
    public function setExpirationYear($expirationYear)
    {
        if (!is_null($expirationYear) && (strlen($expirationYear) > 4)) {
            throw new \InvalidArgumentException('invalid length for $expirationYear when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be smaller than or equal to 4.');
        }
        if (!is_null($expirationYear) && (strlen($expirationYear) < 4)) {
            throw new \InvalidArgumentException('invalid length for $expirationYear when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be bigger than or equal to 4.');
        }
    ...
    public function setIssueNumber($issueNumber)
    {
        if (!is_null($issueNumber) && (strlen($issueNumber) > 2)) {
            throw new \InvalidArgumentException('invalid length for $issueNumber when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be smaller than or equal to 2.');
        }
        if (!is_null($issueNumber) && (strlen($issueNumber) < 1)) {
            throw new \InvalidArgumentException('invalid length for $issueNumber when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be bigger than or equal to 1.');
        }
    ...
    public function setStartMonth($startMonth)
    {
        if (!is_null($startMonth) && (strlen($startMonth) > 2)) {
            throw new \InvalidArgumentException('invalid length for $startMonth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be smaller than or equal to 2.');
        }
        if (!is_null($startMonth) && (strlen($startMonth) < 2)) {
            throw new \InvalidArgumentException('invalid length for $startMonth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be bigger than or equal to 2.');
        }
    ...
    public function setStartYear($startYear)
    {
        if (!is_null($startYear) && (strlen($startYear) > 4)) {
            throw new \InvalidArgumentException('invalid length for $startYear when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be smaller than or equal to 4.');
        }
        if (!is_null($startYear) && (strlen($startYear) < 4)) {
            throw new \InvalidArgumentException('invalid length for $startYear when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseCard., must be bigger than or equal to 4.');
        }
