...
/**
 * InlineResponse201ProcessorInformationAvs Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201ProcessorInformationAvs implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_processorInformation_avs';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (strlen($code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling InlineResponse201ProcessorInformationAvs., must be smaller than or equal to 1.');
        }
    ...
    public function setCodeRaw($codeRaw)
    {
        if (!is_null($codeRaw) && (strlen($codeRaw) > 10)) {
            throw new \InvalidArgumentException('invalid length for $codeRaw when calling InlineResponse201ProcessorInformationAvs., must be smaller than or equal to 10.');
        }
