...
class Ptsv2paymentsBuyerInformationPersonalIdentification implements ArrayAccess
{
    ...
    /**
     * Sets issuedBy
     * @param string $issuedBy If type = DRIVER_LICENSE, this is the State or province where the customer’s driver’s license was issued. Use the twocharacter State, Province, and Territory Codes for the United States and Canada.  ** TeleCheck ** Contact your TeleCheck representative to find out whether this field is required or optional.  ** All Other Processors ** Not used.
     * @return $this
     */
