...
/**
 * PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisaCurrencies Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisaCurrencies implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentProducts_payerAuthentication_configurationInformation_configurations_cardTypes_verifiedByVisa_currencies';
    ...
    public function setAcquirerId($acquirerId)
    {
        if (!is_null($acquirerId) && (!preg_match("/^[a-zA-Z0-9]{6,20}$/", $acquirerId))) {
            throw new \InvalidArgumentException("invalid value for $acquirerId when calling PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisaCurrencies., must conform to the pattern /^[a-zA-Z0-9]{6,20}$/.");
        }
    ...
    public function setProcessorMerchantId($processorMerchantId)
    {
        if (!is_null($processorMerchantId) && (!preg_match("/^[a-zA-Z0-9]{6,35}$/", $processorMerchantId))) {
            throw new \InvalidArgumentException("invalid value for $processorMerchantId when calling PaymentProductsPayerAuthenticationConfigurationInformationConfigurationsCardTypesVerifiedByVisaCurrencies., must conform to the pattern /^[a-zA-Z0-9]{6,35}$/.");
        }
