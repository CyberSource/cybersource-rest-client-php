...
class TssV2TransactionsPost201ResponseEmbeddedMerchantInformation implements ArrayAccess
{
    ...
    /**
     * Sets resellerId
     * @param string $resellerId An unique identification number assigned by CyberSource to identify the submitted request. It is also appended to the endpoint of the resource.  On incremental authorizations, this value with be the same as the identification number returned in the original authorization response.
     * @return $this
     */
