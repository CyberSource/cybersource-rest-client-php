...
/**
 * RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskV1DecisionsPost201Response_riskInformation_paymentInformation';
    ...
    public function setBinCountry($binCountry)
    {
        if (!is_null($binCountry) && (strlen($binCountry) > 255)) {
            throw new \InvalidArgumentException('invalid length for $binCountry when calling RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation., must be smaller than or equal to 255.');
        }
    ...
    public function setAccountType($accountType)
    {
        if (!is_null($accountType) && (strlen($accountType) > 255)) {
            throw new \InvalidArgumentException('invalid length for $accountType when calling RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation., must be smaller than or equal to 255.');
        }
    ...
    public function setIssuer($issuer)
    {
        if (!is_null($issuer) && (strlen($issuer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $issuer when calling RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation., must be smaller than or equal to 255.');
        }
    ...
    public function setScheme($scheme)
    {
        if (!is_null($scheme) && (strlen($scheme) > 255)) {
            throw new \InvalidArgumentException('invalid length for $scheme when calling RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation., must be smaller than or equal to 255.');
        }
    ...
    /**
     * Sets bin
     * @param string $bin Credit card BIN (the first six digits of the credit card).Derived either from the `bin` request field or from the first six characters of the `number` field.
     * @return $this
     */
    public function setBin($bin)
    {
        if (!is_null($bin) && (strlen($bin) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling RiskV1DecisionsPost201ResponseRiskInformationPaymentInformation., must be smaller than or equal to 255.');
        }
