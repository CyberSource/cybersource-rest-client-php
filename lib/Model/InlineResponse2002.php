...
class InlineResponse2002 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'processingInformation' => '\CyberSource\Model\InlineResponse2002ProcessingInformation',
        'processorInformation' => '\CyberSource\Model\InlineResponse2002ProcessorInformation',
        'paymentInformation' => '\CyberSource\Model\InlineResponse2002PaymentInformation',
        'orderInformation' => '\CyberSource\Model\InlineResponse2002OrderInformation',
        'buyerInformation' => '\CyberSource\Model\InlineResponse2002BuyerInformation',
        'merchantInformation' => '\CyberSource\Model\InlineResponse2002MerchantInformation',
        'deviceInformation' => '\CyberSource\Model\InlineResponse2002DeviceInformation'
    ];
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse2002., must be smaller than or equal to 26.');
        }
    ...
    public function setReconciliationId($reconciliationId)
    {
        if (!is_null($reconciliationId) && (strlen($reconciliationId) > 60)) {
            throw new \InvalidArgumentException('invalid length for $reconciliationId when calling InlineResponse2002., must be smaller than or equal to 60.');
        }
     ...
     * @return \CyberSource\Model\InlineResponse2002ProcessingInformation
     */
     ...
     * @param \CyberSource\Model\InlineResponse2002ProcessingInformation $processingInformation
     * @return $this
     */
     ...
     * @return \CyberSource\Model\InlineResponse2002ProcessorInformation
     */
     ...
     * @param \CyberSource\Model\InlineResponse2002ProcessorInformation $processorInformation
     * @return $this
     */
     ...
     * @return \CyberSource\Model\InlineResponse2002PaymentInformation
     */
     ...
     * @param \CyberSource\Model\InlineResponse2002PaymentInformation $paymentInformation
     * @return $this
     */
     ...
     * @return \CyberSource\Model\InlineResponse2002OrderInformation
     */
     ...
     * @param \CyberSource\Model\InlineResponse2002OrderInformation $orderInformation
     * @return $this
     */
     ...
     * @return \CyberSource\Model\InlineResponse2002BuyerInformation
     */
     ...
     * @param \CyberSource\Model\InlineResponse2002BuyerInformation $buyerInformation
     * @return $this
     */
     ...
     * @return \CyberSource\Model\InlineResponse2002DeviceInformation
     */
     ...
     * @param \CyberSource\Model\InlineResponse2002DeviceInformation $deviceInformation
     * @return $this
     */
