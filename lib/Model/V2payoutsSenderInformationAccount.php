...
/**
 * V2payoutsSenderInformationAccount Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2payoutsSenderInformationAccount implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2payouts_senderInformation_account';
    ...
    public function setFundsSource($fundsSource)
    {
        if (!is_null($fundsSource) && (strlen($fundsSource) > 2)) {
            throw new \InvalidArgumentException('invalid length for $fundsSource when calling V2payoutsSenderInformationAccount., must be smaller than or equal to 2.');
        }
        if (!is_null($fundsSource) && (strlen($fundsSource) < 2)) {
            throw new \InvalidArgumentException('invalid length for $fundsSource when calling V2payoutsSenderInformationAccount., must be bigger than or equal to 2.');
        }
    ...
    public function setNumber($number)
    {
        if (!is_null($number) && (strlen($number) > 34)) {
            throw new \InvalidArgumentException('invalid length for $number when calling V2payoutsSenderInformationAccount., must be smaller than or equal to 34.');
        }
