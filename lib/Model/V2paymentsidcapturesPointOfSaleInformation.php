...
/**
 * V2paymentsidcapturesPointOfSaleInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesPointOfSaleInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_pointOfSaleInformation';
    ...
    protected static $swaggerTypes = [
        'emv' => '\CyberSource\Model\V2paymentsidcapturesPointOfSaleInformationEmv',
        'amexCapnData' => 'string'
    ];
    ...
    /**
     * Gets emv
     * @return \CyberSource\Model\V2paymentsidcapturesPointOfSaleInformationEmv
     */
    ...
    /**
     * Sets emv
     * @param \CyberSource\Model\V2paymentsidcapturesPointOfSaleInformationEmv $emv
     * @return $this
     */
    ...
    public function setAmexCapnData($amexCapnData)
    {
        if (!is_null($amexCapnData) && (strlen($amexCapnData) > 12)) {
            throw new \InvalidArgumentException('invalid length for $amexCapnData when calling V2paymentsidcapturesPointOfSaleInformation., must be smaller than or equal to 12.');
        }
