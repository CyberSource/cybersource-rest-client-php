...
class InlineResponse2015 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'voidAmountDetails' => '\CyberSource\Model\InlineResponse2015VoidAmountDetails'
    ];
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse2015., must be smaller than or equal to 26.');
        }
     ...
     * @return \CyberSource\Model\InlineResponse2015VoidAmountDetails
     */
     ...
     * @param \CyberSource\Model\InlineResponse2015VoidAmountDetails $voidAmountDetails
     * @return $this
     */
