...
/**
 * TssV2TransactionsGet200ResponseProcessorInformationCardVerification Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsGet200ResponseProcessorInformationCardVerification implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tssV2TransactionsGet200Response_processorInformation_cardVerification';
    ...
    public function setResultCode($resultCode)
    {
        if (!is_null($resultCode) && (strlen($resultCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $resultCode when calling TssV2TransactionsGet200ResponseProcessorInformationCardVerification., must be smaller than or equal to 1.');
        }
