...
/**
 * InlineResponse2004OrderInformationAmountDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2004OrderInformationAmountDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_4_orderInformation_amountDetails';
    ...
    public function setTotalAmount($totalAmount)
    {
        if (!is_null($totalAmount) && (strlen($totalAmount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $totalAmount when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 19.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 3.');
        }
    ...
    public function setDiscountAmount($discountAmount)
    {
        if (!is_null($discountAmount) && (strlen($discountAmount) > 15)) {
            throw new \InvalidArgumentException('invalid length for $discountAmount when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 15.');
        }
    ...
    public function setDutyAmount($dutyAmount)
    {
        if (!is_null($dutyAmount) && (strlen($dutyAmount) > 15)) {
            throw new \InvalidArgumentException('invalid length for $dutyAmount when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 15.');
        }
    ...
    public function setTaxAmount($taxAmount)
    {
        if (!is_null($taxAmount) && (strlen($taxAmount) > 12)) {
            throw new \InvalidArgumentException('invalid length for $taxAmount when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 12.');
        }
    ...
    public function setNationalTaxIncluded($nationalTaxIncluded)
    {
        if (!is_null($nationalTaxIncluded) && (strlen($nationalTaxIncluded) > 1)) {
            throw new \InvalidArgumentException('invalid length for $nationalTaxIncluded when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 1.');
        }
    ...
    public function setFreightAmount($freightAmount)
    {
        if (!is_null($freightAmount) && (strlen($freightAmount) > 13)) {
            throw new \InvalidArgumentException('invalid length for $freightAmount when calling InlineResponse2004OrderInformationAmountDetails., must be smaller than or equal to 13.');
        }
