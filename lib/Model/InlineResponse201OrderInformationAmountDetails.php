...
/**
 * InlineResponse201OrderInformationAmountDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201OrderInformationAmountDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_orderInformation_amountDetails';
    ...
    /**
     * Sets totalAmount
     * @param string $totalAmount Amount you requested for the payment or capture.  This value is returned for partial authorizations.
     * @return $this
     */
    public function setTotalAmount($totalAmount)
    {
        if (!is_null($totalAmount) && (strlen($totalAmount) > 15)) {
            throw new \InvalidArgumentException('invalid length for $totalAmount when calling InlineResponse201OrderInformationAmountDetails., must be smaller than or equal to 15.');
        }
    ...
    public function setAuthorizedAmount($authorizedAmount)
    {
        if (!is_null($authorizedAmount) && (strlen($authorizedAmount) > 15)) {
            throw new \InvalidArgumentException('invalid length for $authorizedAmount when calling InlineResponse201OrderInformationAmountDetails., must be smaller than or equal to 15.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling InlineResponse201OrderInformationAmountDetails., must be smaller than or equal to 3.');
        }
