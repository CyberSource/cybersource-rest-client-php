...
/**
 * Riskv1authenticationsClientReferenceInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationsClientReferenceInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authentications_clientReferenceInformation';
    ...
    {
        if ((strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Riskv1authenticationsClientReferenceInformation., must be smaller than or equal to 50.');
        }
