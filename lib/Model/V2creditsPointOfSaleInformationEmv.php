...
/**
 * V2creditsPointOfSaleInformationEmv Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2creditsPointOfSaleInformationEmv implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2credits_pointOfSaleInformation_emv';
    ...
    public function setTags($tags)
    {
        if (!is_null($tags) && (strlen($tags) > 1998)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling V2creditsPointOfSaleInformationEmv., must be smaller than or equal to 1998.');
        }
