...
/**
 * V2paymentsidcapturesMerchantInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesMerchantInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_merchantInformation';
    ...
    public function setCardAcceptorReferenceNumber($cardAcceptorReferenceNumber)
    {
        if (!is_null($cardAcceptorReferenceNumber) && (strlen($cardAcceptorReferenceNumber) > 25)) {
            throw new \InvalidArgumentException('invalid length for $cardAcceptorReferenceNumber when calling V2paymentsidcapturesMerchantInformation., must be smaller than or equal to 25.');
        }
    ...
    public function setCategoryCode($categoryCode)
    {
        ...
        if (!is_null($categoryCode) && ($categoryCode > 9999)) {
            throw new \InvalidArgumentException('invalid value for $categoryCode when calling V2paymentsidcapturesMerchantInformation., must be smaller than or equal to 9999.');
        }
    ...
    public function setVatRegistrationNumber($vatRegistrationNumber)
    {
        if (!is_null($vatRegistrationNumber) && (strlen($vatRegistrationNumber) > 21)) {
            throw new \InvalidArgumentException('invalid length for $vatRegistrationNumber when calling V2paymentsidcapturesMerchantInformation., must be smaller than or equal to 21.');
        }
