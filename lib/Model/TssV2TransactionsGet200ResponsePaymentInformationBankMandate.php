...
class TssV2TransactionsGet200ResponsePaymentInformationBankMandate implements ArrayAccess
{
     ...
     * @param string $referenceNumber The description for this field is not available.
     * @return $this
     */
    ...
    /**
     * Sets recurringType
     * @param string $recurringType The description for this field is not available.
     * @return $this
     */
    ...
    /**
     * Sets id
     * @param string $id The description for this field is not available.
     * @return $this
     */
