...
class TssV2TransactionsGet200ResponsePaymentInformationBankMandate implements ArrayAccess
{
    ...
    /**
     * Sets id
     * @param string $id The mandate ID. Required only for the United Kingdom.  For details, see the `mandate_id` request field description in [Ingenico ePayments Developer Guide For Direct Debits.](https://apps.cybersource.com/library/documentation/dev_guides/Ingenico_ePayments_Dev/html/wwhelp/wwhimpl/js/html/wwhelp.htm)
     * @return $this
     */
