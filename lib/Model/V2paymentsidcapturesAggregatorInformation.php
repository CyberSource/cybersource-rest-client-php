...
/**
 * V2paymentsidcapturesAggregatorInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesAggregatorInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_aggregatorInformation';
    ...
    protected static $swaggerTypes = [
        'aggregatorId' => 'string',
        'name' => 'string',
        'subMerchant' => '\CyberSource\Model\V2paymentsidcapturesAggregatorInformationSubMerchant'
    ];
    ...
    /**
     * Sets aggregatorId
     * @param string $aggregatorId Value that identifies you as a payment aggregator. Get this value from the processor.  For processor-specific information, see the aggregator_id field in [Credit Card Services Using the SCMP API.](http://apps.cybersource.com/library/documentation/dev_guides/CC_Svcs_SCMP_API/html)
     * @return $this
     */
    public function setAggregatorId($aggregatorId)
    {
        if (!is_null($aggregatorId) && (strlen($aggregatorId) > 20)) {
            throw new \InvalidArgumentException('invalid length for $aggregatorId when calling V2paymentsidcapturesAggregatorInformation., must be smaller than or equal to 20.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 37)) {
            throw new \InvalidArgumentException('invalid length for $name when calling V2paymentsidcapturesAggregatorInformation., must be smaller than or equal to 37.');
        }
    ...
    /**
     * Gets subMerchant
     * @return \CyberSource\Model\V2paymentsidcapturesAggregatorInformationSubMerchant
     */
    ...
    /**
     * Sets subMerchant
     * @param \CyberSource\Model\V2paymentsidcapturesAggregatorInformationSubMerchant $subMerchant
     * @return $this
     */
