...
/**
 * InlineResponse2002ProcessorInformationCardVerification Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2002ProcessorInformationCardVerification implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_2_processorInformation_cardVerification';
    ...
    public function setResultCode($resultCode)
    {
        if (!is_null($resultCode) && (strlen($resultCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $resultCode when calling InlineResponse2002ProcessorInformationCardVerification., must be smaller than or equal to 1.');
        }
