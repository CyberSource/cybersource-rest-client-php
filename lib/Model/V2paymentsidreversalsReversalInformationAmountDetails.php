...
/**
 * V2paymentsidreversalsReversalInformationAmountDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidreversalsReversalInformationAmountDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidreversals_reversalInformation_amountDetails';
    ...
    public function setTotalAmount($totalAmount)
    {
        if (!is_null($totalAmount) && (strlen($totalAmount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $totalAmount when calling V2paymentsidreversalsReversalInformationAmountDetails., must be smaller than or equal to 19.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling V2paymentsidreversalsReversalInformationAmountDetails., must be smaller than or equal to 3.');
        }
