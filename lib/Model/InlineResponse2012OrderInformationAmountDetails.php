...
/**
 * InlineResponse2012OrderInformationAmountDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2012OrderInformationAmountDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_2_orderInformation_amountDetails';
    ...
    public function setTotalAmount($totalAmount)
    {
        if (!is_null($totalAmount) && (strlen($totalAmount) > 15)) {
            throw new \InvalidArgumentException('invalid length for $totalAmount when calling InlineResponse2012OrderInformationAmountDetails., must be smaller than or equal to 15.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling InlineResponse2012OrderInformationAmountDetails., must be smaller than or equal to 3.');
        }
