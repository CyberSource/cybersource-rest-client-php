...
class V2paymentsClientReferenceInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2payments_clientReferenceInformation';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (strlen($code) > 50)) {
            throw new \InvalidArgumentException('invalid length for $code when calling V2paymentsClientReferenceInformation., must be smaller than or equal to 50.');
        }
