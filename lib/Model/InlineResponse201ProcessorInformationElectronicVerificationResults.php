...
/**
 * InlineResponse201ProcessorInformationElectronicVerificationResults Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201ProcessorInformationElectronicVerificationResults implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_processorInformation_electronicVerificationResults';
    ...
    /**
     * Sets code
     * @param string $code Mapped Electronic Verification response code for the customerâ€™s name.
     * @return $this
     */
    public function setCode($code)
    {
        if (!is_null($code) && (strlen($code) > 1)) {
            throw new \InvalidArgumentException('invalid length for $code when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets codeRaw
     * @param string $codeRaw Raw Electronic Verification response code from the processor for the customerâ€™s last name
     * @return $this
     */
    public function setCodeRaw($codeRaw)
    {
        if (!is_null($codeRaw) && (strlen($codeRaw) > 1)) {
            throw new \InvalidArgumentException('invalid length for $codeRaw when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets email
     * @param string $email Mapped Electronic Verification response code for the customerâ€™s email address.
     * @return $this
     */
    public function setEmail($email)
    {
        if (!is_null($email) && (strlen($email) > 1)) {
            throw new \InvalidArgumentException('invalid length for $email when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets emailRaw
     * @param string $emailRaw Raw Electronic Verification response code from the processor for the customerâ€™s email address.
     * @return $this
     */
    public function setEmailRaw($emailRaw)
    {
        if (!is_null($emailRaw) && (strlen($emailRaw) > 1)) {
            throw new \InvalidArgumentException('invalid length for $emailRaw when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets phoneNumber
     * @param string $phoneNumber Mapped Electronic Verification response code for the customerâ€™s phone number.
     * @return $this
     */
    public function setPhoneNumber($phoneNumber)
    {
        if (!is_null($phoneNumber) && (strlen($phoneNumber) > 1)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumber when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets phoneNumberRaw
     * @param string $phoneNumberRaw Raw Electronic Verification response code from the processor for the customerâ€™s phone number.
     * @return $this
     */
    public function setPhoneNumberRaw($phoneNumberRaw)
    {
        if (!is_null($phoneNumberRaw) && (strlen($phoneNumberRaw) > 1)) {
            throw new \InvalidArgumentException('invalid length for $phoneNumberRaw when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets postalCode
     * @param string $postalCode Mapped Electronic Verification response code for the customerâ€™s postal code.
     * @return $this
     */
    public function setPostalCode($postalCode)
    {
        if (!is_null($postalCode) && (strlen($postalCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCode when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets postalCodeRaw
     * @param string $postalCodeRaw Raw Electronic Verification response code from the processor for the customerâ€™s postal code.
     * @return $this
     */
    public function setPostalCodeRaw($postalCodeRaw)
    {
        if (!is_null($postalCodeRaw) && (strlen($postalCodeRaw) > 1)) {
            throw new \InvalidArgumentException('invalid length for $postalCodeRaw when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets street
     * @param string $street Mapped Electronic Verification response code for the customerâ€™s street address.
     * @return $this
     */
    public function setStreet($street)
    {
        if (!is_null($street) && (strlen($street) > 1)) {
            throw new \InvalidArgumentException('invalid length for $street when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets streetRaw
     * @param string $streetRaw Raw Electronic Verification response code from the processor for the customerâ€™s street address.
     * @return $this
     */
    public function setStreetRaw($streetRaw)
    {
        if (!is_null($streetRaw) && (strlen($streetRaw) > 1)) {
            throw new \InvalidArgumentException('invalid length for $streetRaw when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if (!is_null($name) && (strlen($name) > 30)) {
            throw new \InvalidArgumentException('invalid length for $name when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 30.');
        }
    ...
    /**
     * Sets nameRaw
     * @param string $nameRaw TODO
     * @return $this
     */
    public function setNameRaw($nameRaw)
    {
        if (!is_null($nameRaw) && (strlen($nameRaw) > 30)) {
            throw new \InvalidArgumentException('invalid length for $nameRaw when calling InlineResponse201ProcessorInformationElectronicVerificationResults., must be smaller than or equal to 30.');
        }
