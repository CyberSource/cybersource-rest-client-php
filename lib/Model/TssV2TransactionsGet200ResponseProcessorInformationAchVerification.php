...
/**
 * TssV2TransactionsGet200ResponseProcessorInformationAchVerification Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsGet200ResponseProcessorInformationAchVerification implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tssV2TransactionsGet200Response_processorInformation_achVerification';
    ...
    /**
     * Sets resultCode
     * @param string $resultCode The description for this field is not available..
     * @return $this
     */
    public function setResultCode($resultCode)
    {
        if (!is_null($resultCode) && (strlen($resultCode) > 1)) {
            throw new \InvalidArgumentException('invalid length for $resultCode when calling TssV2TransactionsGet200ResponseProcessorInformationAchVerification., must be smaller than or equal to 1.');
        }
    ...
    /**
     * Sets resultCodeRaw
     * @param string $resultCodeRaw The description for this field is not available.
     * @return $this
     */
    public function setResultCodeRaw($resultCodeRaw)
    {
        if (!is_null($resultCodeRaw) && (strlen($resultCodeRaw) > 10)) {
            throw new \InvalidArgumentException('invalid length for $resultCodeRaw when calling TssV2TransactionsGet200ResponseProcessorInformationAchVerification., must be smaller than or equal to 10.');
        }
