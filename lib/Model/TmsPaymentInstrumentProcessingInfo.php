...
class TmsPaymentInstrumentProcessingInfo implements ArrayAccess
{
     ...
     * @param bool $billPaymentProgramEnabled Flag that indicates that this is a payment for a bill or for an existing contractual loan. Possible Values: - `true`: Bill payment or loan payment. - `false` (default): Not a bill payment or loan payment.
     * @return $this
     */
