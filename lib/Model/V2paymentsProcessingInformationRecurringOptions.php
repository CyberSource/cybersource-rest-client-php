...
/**
 * V2paymentsProcessingInformationRecurringOptions Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsProcessingInformationRecurringOptions implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2payments_processingInformation_recurringOptions';
     ...
     * @param bool $firstRecurringPayment Flag that indicates whether this transaction is the first in a series of recurring payments. This field is supported only for **Atos**, **FDC Nashville Global**, and **OmniPay Direct**.
     * @return $this
     */
