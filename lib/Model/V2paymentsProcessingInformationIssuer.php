...
/**
 * V2paymentsProcessingInformationIssuer Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsProcessingInformationIssuer implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2payments_processingInformation_issuer';
    ...
    public function setDiscretionaryData($discretionaryData)
    {
        if (!is_null($discretionaryData) && (strlen($discretionaryData) > 255)) {
            throw new \InvalidArgumentException('invalid length for $discretionaryData when calling V2paymentsProcessingInformationIssuer., must be smaller than or equal to 255.');
        }
