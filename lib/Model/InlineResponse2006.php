...
class InlineResponse2006 implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'creditAmountDetails' => '\CyberSource\Model\InlineResponse2014CreditAmountDetails'
    ];
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling InlineResponse2006., must be smaller than or equal to 26.');
        }
    ...
    public function setReconciliationId($reconciliationId)
    {
        if (!is_null($reconciliationId) && (strlen($reconciliationId) > 60)) {
            throw new \InvalidArgumentException('invalid length for $reconciliationId when calling InlineResponse2006., must be smaller than or equal to 60.');
        }
     ...
     * @return \CyberSource\Model\InlineResponse2014CreditAmountDetails
     */
     ...
     * @param \CyberSource\Model\InlineResponse2014CreditAmountDetails $creditAmountDetails
     * @return $this
     */
