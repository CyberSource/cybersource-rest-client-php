...
/**
 * PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentProducts_cardProcessing_configurationInformation_configurations_common_processors';
    ...
    protected static $swaggerTypes = [
        ...
        'abaNumber' => 'string',
        'acquirer' => '\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer',
        'merchantId' => 'string',
        'terminalId' => 'string',
        'paymentTypes' => 'map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes]',
        'currencies' => 'map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1]',
        'sicCode' => 'string',
    ...
    /**
     * Gets acquirer
     * @return \CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer
     */
    ...
    /**
     * Sets acquirer
     * @param \CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonAcquirer $acquirer
     * @return $this
     */
    ...
    /**
     * Gets paymentTypes
     * @return map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes]
     */
    ...
    /**
     * Sets paymentTypes
     * @param map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonPaymentTypes] $paymentTypes Valid values are: * VISA * MASTERCARD * AMERICAN_EXPRESS * CUP * EFTPOS * DINERS_CLUB * DISCOVER * JCB
     * @return $this
     */
    ...
    /**
     * Gets currencies
     * @return map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonCurrencies1] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */
    ...
    public function setMerchantTier($merchantTier)
    {
        if (!is_null($merchantTier) && (!preg_match("/^[0-9]+$/", $merchantTier))) {
            throw new \InvalidArgumentException("invalid value for $merchantTier when calling PaymentProductsCardProcessingConfigurationInformationConfigurationsCommonProcessors., must conform to the pattern /^[0-9]+$/.");
        }
