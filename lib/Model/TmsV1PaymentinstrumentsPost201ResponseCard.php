...
/**
 * TmsV1PaymentinstrumentsPost201ResponseCard Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TmsV1PaymentinstrumentsPost201ResponseCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsV1PaymentinstrumentsPost201Response_card';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['expirationMonth']) && (strlen($this->container['expirationMonth']) > 12)) {
            $invalid_properties[] = "invalid value for 'expirationMonth', the character length must be smaller than or equal to 12.";
        }

        if (!is_null($this->container['expirationMonth']) && (strlen($this->container['expirationMonth']) < 1)) {
            $invalid_properties[] = "invalid value for 'expirationMonth', the character length must be bigger than or equal to 1.";
        }
    ...
    public function valid()
    {
        ...
        if (strlen($this->container['expirationMonth']) > 12) {
            return false;
        }
        if (strlen($this->container['expirationMonth']) < 1) {
            return false;
        }
        $allowed_values = $this->getTypeAllowableValues();
        if (!in_array($this->container['type'], $allowed_values)) {
    ...
    {
        if (!is_null($expirationMonth) && (strlen($expirationMonth) > 12)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling TmsV1PaymentinstrumentsPost201ResponseCard., must be smaller than or equal to 12.');
        }
        if (!is_null($expirationMonth) && (strlen($expirationMonth) < 1)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling TmsV1PaymentinstrumentsPost201ResponseCard., must be bigger than or equal to 1.');
        }
