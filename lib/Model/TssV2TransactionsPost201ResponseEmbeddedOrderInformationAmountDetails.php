...
/**
 * TssV2TransactionsPost201ResponseEmbeddedOrderInformationAmountDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsPost201ResponseEmbeddedOrderInformationAmountDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tssV2TransactionsPost201Response__embedded_orderInformation_amountDetails';
    ...
    public function setTotalAmount($totalAmount)
    {
        if (!is_null($totalAmount) && (strlen($totalAmount) > 19)) {
            throw new \InvalidArgumentException('invalid length for $totalAmount when calling TssV2TransactionsPost201ResponseEmbeddedOrderInformationAmountDetails., must be smaller than or equal to 19.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling TssV2TransactionsPost201ResponseEmbeddedOrderInformationAmountDetails., must be smaller than or equal to 3.');
        }
