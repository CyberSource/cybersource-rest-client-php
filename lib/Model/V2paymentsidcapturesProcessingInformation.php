...
/**
 * V2paymentsidcapturesProcessingInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesProcessingInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_processingInformation';
    ...
    protected static $swaggerTypes = [
        ...
        'authorizationOptions' => '\CyberSource\Model\V2paymentsidcapturesProcessingInformationAuthorizationOptions',
        'captureOptions' => '\CyberSource\Model\V2paymentsidcapturesProcessingInformationCaptureOptions'
    ];
    ...
    public function setPaymentSolution($paymentSolution)
    {
        if (!is_null($paymentSolution) && (strlen($paymentSolution) > 12)) {
            throw new \InvalidArgumentException('invalid length for $paymentSolution when calling V2paymentsidcapturesProcessingInformation., must be smaller than or equal to 12.');
        }
    ...
    public function setReconciliationId($reconciliationId)
    {
        if (!is_null($reconciliationId) && (strlen($reconciliationId) > 60)) {
            throw new \InvalidArgumentException('invalid length for $reconciliationId when calling V2paymentsidcapturesProcessingInformation., must be smaller than or equal to 60.');
        }
    ...
    public function setLinkId($linkId)
    {
        if (!is_null($linkId) && (strlen($linkId) > 26)) {
            throw new \InvalidArgumentException('invalid length for $linkId when calling V2paymentsidcapturesProcessingInformation., must be smaller than or equal to 26.');
        }
    ...
    public function setReportGroup($reportGroup)
    {
        if (!is_null($reportGroup) && (strlen($reportGroup) > 25)) {
            throw new \InvalidArgumentException('invalid length for $reportGroup when calling V2paymentsidcapturesProcessingInformation., must be smaller than or equal to 25.');
        }
    ...
    public function setVisaCheckoutId($visaCheckoutId)
    {
        if (!is_null($visaCheckoutId) && (strlen($visaCheckoutId) > 48)) {
            throw new \InvalidArgumentException('invalid length for $visaCheckoutId when calling V2paymentsidcapturesProcessingInformation., must be smaller than or equal to 48.');
        }
    ...
    public function setPurchaseLevel($purchaseLevel)
    {
        if (!is_null($purchaseLevel) && (strlen($purchaseLevel) > 1)) {
            throw new \InvalidArgumentException('invalid length for $purchaseLevel when calling V2paymentsidcapturesProcessingInformation., must be smaller than or equal to 1.');
        }
     ...
     * @return \CyberSource\Model\V2paymentsidcapturesProcessingInformationAuthorizationOptions
     */
     ...
     * @param \CyberSource\Model\V2paymentsidcapturesProcessingInformationAuthorizationOptions $authorizationOptions
     * @return $this
     */
    ...
    /**
     * Gets captureOptions
     * @return \CyberSource\Model\V2paymentsidcapturesProcessingInformationCaptureOptions
     */
    ...
    /**
     * Sets captureOptions
     * @param \CyberSource\Model\V2paymentsidcapturesProcessingInformationCaptureOptions $captureOptions
     * @return $this
     */
