...
/**
 * InlineResponse201PointOfSaleInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201PointOfSaleInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_pointOfSaleInformation';
    ...
    protected static $swaggerTypes = [
        'emv' => '\CyberSource\Model\InlineResponse201PointOfSaleInformationEmv',
        'amexCapnData' => 'string'
    ];
    ...
    /**
     * Gets emv
     * @return \CyberSource\Model\InlineResponse201PointOfSaleInformationEmv
     */
    ...
    /**
     * Sets emv
     * @param \CyberSource\Model\InlineResponse201PointOfSaleInformationEmv $emv
     * @return $this
     */
    ...
    public function setAmexCapnData($amexCapnData)
    {
        if (!is_null($amexCapnData) && (strlen($amexCapnData) > 12)) {
            throw new \InvalidArgumentException('invalid length for $amexCapnData when calling InlineResponse201PointOfSaleInformation., must be smaller than or equal to 12.');
        }
