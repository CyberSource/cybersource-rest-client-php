...
class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedBuyerInformation implements ArrayAccess
{
    ...
    public function setDateOBirth($dateOBirth)
    {
        if (!is_null($dateOBirth) && (strlen($dateOBirth) > 10)) {
            throw new \InvalidArgumentException('invalid length for $dateOBirth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedBuyerInformation., must be smaller than or equal to 10.');
        }
        if (!is_null($dateOBirth) && (strlen($dateOBirth) < 8)) {
            throw new \InvalidArgumentException('invalid length for $dateOBirth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseEmbeddedBuyerInformation., must be bigger than or equal to 8.');
        }
