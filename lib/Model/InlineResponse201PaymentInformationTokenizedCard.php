...
/**
 * InlineResponse201PaymentInformationTokenizedCard Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201PaymentInformationTokenizedCard implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_paymentInformation_tokenizedCard';
    ...
    public function setPrefix($prefix)
    {
        if (!is_null($prefix) && (strlen($prefix) > 6)) {
            throw new \InvalidArgumentException('invalid length for $prefix when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 6.');
        }
    ...
    public function setSuffix($suffix)
    {
        if (!is_null($suffix) && (strlen($suffix) > 4)) {
            throw new \InvalidArgumentException('invalid length for $suffix when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 4.');
        }
    ...
    public function setType($type)
    {
        if (!is_null($type) && (strlen($type) > 3)) {
            throw new \InvalidArgumentException('invalid length for $type when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 3.');
        }
    ...
    public function setAssuranceLevel($assuranceLevel)
    {
        if (!is_null($assuranceLevel) && (strlen($assuranceLevel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $assuranceLevel when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 2.');
        }
    ...
    public function setExpirationMonth($expirationMonth)
    {
        if (!is_null($expirationMonth) && (strlen($expirationMonth) > 2)) {
            throw new \InvalidArgumentException('invalid length for $expirationMonth when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 2.');
        }
    ...
    public function setExpirationYear($expirationYear)
    {
        if (!is_null($expirationYear) && (strlen($expirationYear) > 4)) {
            throw new \InvalidArgumentException('invalid length for $expirationYear when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 4.');
        }
    ...
    public function setRequestorId($requestorId)
    {
        if (!is_null($requestorId) && (strlen($requestorId) > 11)) {
            throw new \InvalidArgumentException('invalid length for $requestorId when calling InlineResponse201PaymentInformationTokenizedCard., must be smaller than or equal to 11.');
        }
