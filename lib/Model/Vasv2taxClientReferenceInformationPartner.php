...
/**
 * Vasv2taxClientReferenceInformationPartner Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Vasv2taxClientReferenceInformationPartner implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'vasv2tax_clientReferenceInformation_partner';
    ...
    public function setDeveloperId($developerId)
    {
        if (!is_null($developerId) && (strlen($developerId) > 8)) {
            throw new \InvalidArgumentException('invalid length for $developerId when calling Vasv2taxClientReferenceInformationPartner., must be smaller than or equal to 8.');
        }
    ...
    public function setSolutionId($solutionId)
    {
        if (!is_null($solutionId) && (strlen($solutionId) > 8)) {
            throw new \InvalidArgumentException('invalid length for $solutionId when calling Vasv2taxClientReferenceInformationPartner., must be smaller than or equal to 8.');
        }
