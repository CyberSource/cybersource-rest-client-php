 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Tmsv1instrumentidentifiersMerchantInitiatedTransaction implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsv1instrumentidentifiers_processingInformation_authorizationOptions_initiator_merchantInitiatedTransaction';
    ...
    public function setPreviousTransactionId($previousTransactionId)
    {
        if (!is_null($previousTransactionId) && (strlen($previousTransactionId) > 15)) {
            throw new \InvalidArgumentException('invalid length for $previousTransactionId when calling Tmsv1instrumentidentifiersProcessingInformationAuthorizationOptionsInitiatorMerchantInitiatedTransaction., must be smaller than or equal to 15.');
        }
