...
/**
 * V2paymentsidcapturesOrderInformationInvoiceDetails Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class V2paymentsidcapturesOrderInformationInvoiceDetails implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'v2paymentsidcaptures_orderInformation_invoiceDetails';
    ...
    public function setPurchaseOrderNumber($purchaseOrderNumber)
    {
        if (!is_null($purchaseOrderNumber) && (strlen($purchaseOrderNumber) > 25)) {
            throw new \InvalidArgumentException('invalid length for $purchaseOrderNumber when calling V2paymentsidcapturesOrderInformationInvoiceDetails., must be smaller than or equal to 25.');
        }
    ...
    public function setPurchaseOrderDate($purchaseOrderDate)
    {
        if (!is_null($purchaseOrderDate) && (strlen($purchaseOrderDate) > 10)) {
            throw new \InvalidArgumentException('invalid length for $purchaseOrderDate when calling V2paymentsidcapturesOrderInformationInvoiceDetails., must be smaller than or equal to 10.');
        }
    ...
    public function setPurchaseContactName($purchaseContactName)
    {
        if (!is_null($purchaseContactName) && (strlen($purchaseContactName) > 36)) {
            throw new \InvalidArgumentException('invalid length for $purchaseContactName when calling V2paymentsidcapturesOrderInformationInvoiceDetails., must be smaller than or equal to 36.');
        }
    ...
    public function setVatInvoiceReferenceNumber($vatInvoiceReferenceNumber)
    {
        if (!is_null($vatInvoiceReferenceNumber) && (strlen($vatInvoiceReferenceNumber) > 15)) {
            throw new \InvalidArgumentException('invalid length for $vatInvoiceReferenceNumber when calling V2paymentsidcapturesOrderInformationInvoiceDetails., must be smaller than or equal to 15.');
        }
    ...
    public function setCommodityCode($commodityCode)
    {
        if (!is_null($commodityCode) && (strlen($commodityCode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $commodityCode when calling V2paymentsidcapturesOrderInformationInvoiceDetails., must be smaller than or equal to 4.');
        }
