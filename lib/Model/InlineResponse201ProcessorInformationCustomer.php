...
/**
 * InlineResponse201ProcessorInformationCustomer Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201ProcessorInformationCustomer implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_processorInformation_customer';
    ...
    public function setPersonalIdResult($personalIdResult)
    {
        if (!is_null($personalIdResult) && (strlen($personalIdResult) > 1)) {
            throw new \InvalidArgumentException('invalid length for $personalIdResult when calling InlineResponse201ProcessorInformationCustomer., must be smaller than or equal to 1.');
        }
