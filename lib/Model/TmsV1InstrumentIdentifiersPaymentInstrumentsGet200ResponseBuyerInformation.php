...
/**
 * TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tmsV1InstrumentIdentifiersPaymentInstrumentsGet200Response_buyerInformation';
    ...
    protected static $swaggerTypes = [
        ...
        'currency' => 'string',
        'dateOBirth' => 'string',
        'personalIdentification' => '\CyberSource\Model\TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformationPersonalIdentification[]'
    ];
    ...
    public function setCompanyTaxID($companyTaxID)
    {
        if (!is_null($companyTaxID) && (strlen($companyTaxID) > 9)) {
            throw new \InvalidArgumentException('invalid length for $companyTaxID when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation., must be smaller than or equal to 9.');
        }
    ...
    public function setCurrency($currency)
    {
        if (!is_null($currency) && (strlen($currency) > 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation., must be smaller than or equal to 3.');
        }
        if (!is_null($currency) && (strlen($currency) < 3)) {
            throw new \InvalidArgumentException('invalid length for $currency when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation., must be bigger than or equal to 3.');
        }
    ...
    public function setDateOBirth($dateOBirth)
    {
        if (!is_null($dateOBirth) && (strlen($dateOBirth) > 10)) {
            throw new \InvalidArgumentException('invalid length for $dateOBirth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation., must be smaller than or equal to 10.');
        }
        if (!is_null($dateOBirth) && (strlen($dateOBirth) < 8)) {
            throw new \InvalidArgumentException('invalid length for $dateOBirth when calling TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformation., must be bigger than or equal to 8.');
        }
     ...
     * @return \CyberSource\Model\TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformationPersonalIdentification[]
     */
     ...
     * @param \CyberSource\Model\TmsV1InstrumentIdentifiersPaymentInstrumentsGet200ResponseBuyerInformationPersonalIdentification[] $personalIdentification
     * @return $this
     */
