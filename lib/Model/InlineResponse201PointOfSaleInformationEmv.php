...
/**
 * InlineResponse201PointOfSaleInformationEmv Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201PointOfSaleInformationEmv implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_pointOfSaleInformation_emv';
    ...
    public function setTags($tags)
    {
        if (!is_null($tags) && (strlen($tags) > 1998)) {
            throw new \InvalidArgumentException('invalid length for $tags when calling InlineResponse201PointOfSaleInformationEmv., must be smaller than or equal to 1998.');
        }
