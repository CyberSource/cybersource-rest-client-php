...
class Ptsv2paymentsInstallmentInformation implements ArrayAccess
{
    ...
    /**
     * Sets amount
     * @param string $amount Amount for the current installment payment.  This field is supported only for CyberSource through VisaNet. See \"Installment Payments,\" page 127.
     * @return $this
     */
    ...
    /**
     * Sets frequency
     * @param string $frequency Installment Frequency of the installment payments.  This field is supported only for CyberSource through VisaNet. Possible values: - B: Biweekly - M: Monthly - W: Weekly  See \"Installment Payments,\" page 127.
     * @return $this
     */
    ...
    /**
     * Sets totalAmount
     * @param string $totalAmount Total amount of the loan that is being paid in installments. This field is supported only for CyberSource through VisaNet. See \"Installment Payments,\" page 127.
     * @return $this
     */
     ...
     * @param string $eligibilityInquiry Indicates whether the authorization request is a Crediario eligibility inquiry.  See Installment Payments on CyberSource through VisaNet.  Set the value for this field to `Crediario`.  This field is supported only for Crediario installment payments in Brazil on CyberSource through VisaNet.
     * @return $this
     */
