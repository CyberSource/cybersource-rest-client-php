...
class Ptsv2paymentsOrderInformationBillTo implements ArrayAccess
{
    ...
    public function setAdministrativeArea($administrativeArea)
    {
        if (!is_null($administrativeArea) && (strlen($administrativeArea) > 2)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling Ptsv2paymentsOrderInformationBillTo., must be smaller than or equal to 2.');
        }
