...
/**
 * Riskv1decisionsPaymentInformationBank Class Doc Comment
 *
 * @category    Class
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1decisionsPaymentInformationBank implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1decisions_paymentInformation_bank';
    ...
    public function setAccountNumber($accountNumber)
    {
        if (!is_null($accountNumber) && (strlen($accountNumber) > 30)) {
            throw new \InvalidArgumentException('invalid length for $accountNumber when calling Riskv1decisionsPaymentInformationBank., must be smaller than or equal to 30.');
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (strlen($code) > 15)) {
            throw new \InvalidArgumentException('invalid length for $code when calling Riskv1decisionsPaymentInformationBank., must be smaller than or equal to 15.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (strlen($country) > 2)) {
            throw new \InvalidArgumentException('invalid length for $country when calling Riskv1decisionsPaymentInformationBank., must be smaller than or equal to 2.');
        }
    ...
    public function setIban($iban)
    {
        if (!is_null($iban) && (strlen($iban) > 30)) {
            throw new \InvalidArgumentException('invalid length for $iban when calling Riskv1decisionsPaymentInformationBank., must be smaller than or equal to 30.');
        }
