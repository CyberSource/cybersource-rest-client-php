...
/**
 * PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayouts Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayouts implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'paymentProducts_cardProcessing_configurationInformation_configurations_features_cardNotPresent_payouts';
    ...
    protected static $swaggerTypes = [
        ...
        'networkOrder' => 'string',
        'currencies' => 'map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayoutsCurrencies]',
        'merchantId' => 'string',
        'terminalId' => 'string'
    ];
    ...
    /**
     * Gets currencies
     * @return map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayoutsCurrencies]
     */
    ...
    /**
     * Sets currencies
     * @param map[string,\CyberSource\Model\PaymentProductsCardProcessingConfigurationInformationConfigurationsFeaturesCardNotPresentPayoutsCurrencies] $currencies Three-character [ISO 4217 ALPHA-3 Standard Currency Codes.](http://apps.cybersource.com/library/documentation/sbc/quickref/currencies.pdf)
     * @return $this
     */
