...
/**
 * Riskv1authenticationsPaymentInformationFluidData Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Riskv1authenticationsPaymentInformationFluidData implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'riskv1authentications_paymentInformation_fluidData';
    ...
    public function setValue($value)
    {
        if ((strlen($value) > 3072)) {
            throw new \InvalidArgumentException('invalid length for $value when calling Riskv1authenticationsPaymentInformationFluidData., must be smaller than or equal to 3072.');
        }
    ...
    public function setDescriptor($descriptor)
    {
        if (!is_null($descriptor) && (strlen($descriptor) > 128)) {
            throw new \InvalidArgumentException('invalid length for $descriptor when calling Riskv1authenticationsPaymentInformationFluidData., must be smaller than or equal to 128.');
        }
    ...
    public function setEncoding($encoding)
    {
        if (!is_null($encoding) && (strlen($encoding) > 6)) {
            throw new \InvalidArgumentException('invalid length for $encoding when calling Riskv1authenticationsPaymentInformationFluidData., must be smaller than or equal to 6.');
        }
