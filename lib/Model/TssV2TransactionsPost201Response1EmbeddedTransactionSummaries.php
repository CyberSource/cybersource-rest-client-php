...
/**
 * TssV2TransactionsPost201Response1EmbeddedTransactionSummaries Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TssV2TransactionsPost201Response1EmbeddedTransactionSummaries implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'tssV2TransactionsPost201Response_1__embedded_transactionSummaries';
    ...
    protected static $swaggerTypes = [
        ...
        'paymentInformation' => '\CyberSource\Model\TssV2TransactionsPost201Response1EmbeddedPaymentInformation',
    ...
    public function setId($id)
    {
        if (!is_null($id) && (strlen($id) > 26)) {
            throw new \InvalidArgumentException('invalid length for $id when calling TssV2TransactionsPost201Response1EmbeddedTransactionSummaries., must be smaller than or equal to 26.');
        }
     ...
     * @return \CyberSource\Model\TssV2TransactionsPost201Response1EmbeddedPaymentInformation
     */
     ...
     * @param \CyberSource\Model\TssV2TransactionsPost201Response1EmbeddedPaymentInformation $paymentInformation
     * @return $this
     */
