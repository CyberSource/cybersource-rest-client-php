...
/**
 * InlineResponse2002OrderInformationLineItems Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse2002OrderInformationLineItems implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_200_2_orderInformation_lineItems';
    ...
    public function setProductCode($productCode)
    {
        if (!is_null($productCode) && (strlen($productCode) > 255)) {
            throw new \InvalidArgumentException('invalid length for $productCode when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 255.');
        }
    ...
    public function setProductName($productName)
    {
        if (!is_null($productName) && (strlen($productName) > 255)) {
            throw new \InvalidArgumentException('invalid length for $productName when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 255.');
        }
    ...
    public function setProductSku($productSku)
    {
        if (!is_null($productSku) && (strlen($productSku) > 255)) {
            throw new \InvalidArgumentException('invalid length for $productSku when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 255.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity > 9999999999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 9999999999.');
        }
        if (!is_null($quantity) && ($quantity < 1)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InlineResponse2002OrderInformationLineItems., must be bigger than or equal to 1.');
        }
    ...
    public function setUnitPrice($unitPrice)
    {
        if (!is_null($unitPrice) && (strlen($unitPrice) > 15)) {
            throw new \InvalidArgumentException('invalid length for $unitPrice when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 15.');
        }
    ...
    public function setUnitOfMeasure($unitOfMeasure)
    {
        if (!is_null($unitOfMeasure) && (strlen($unitOfMeasure) > 12)) {
            throw new \InvalidArgumentException('invalid length for $unitOfMeasure when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 12.');
        }
    ...
    public function setTotalAmount($totalAmount)
    {
        if (!is_null($totalAmount) && (strlen($totalAmount) > 13)) {
            throw new \InvalidArgumentException('invalid length for $totalAmount when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 13.');
        }
    ...
    public function setTaxAmount($taxAmount)
    {
        if (!is_null($taxAmount) && (strlen($taxAmount) > 15)) {
            throw new \InvalidArgumentException('invalid length for $taxAmount when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 15.');
        }
    ...
    public function setTaxRate($taxRate)
    {
        if (!is_null($taxRate) && (strlen($taxRate) > 7)) {
            throw new \InvalidArgumentException('invalid length for $taxRate when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 7.');
        }
    ...
    public function setTaxTypeCode($taxTypeCode)
    {
        if (!is_null($taxTypeCode) && (strlen($taxTypeCode) > 4)) {
            throw new \InvalidArgumentException('invalid length for $taxTypeCode when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 4.');
        }
    ...
    public function setCommodityCode($commodityCode)
    {
        if (!is_null($commodityCode) && (strlen($commodityCode) > 15)) {
            throw new \InvalidArgumentException('invalid length for $commodityCode when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 15.');
        }
    ...
    public function setDiscountAmount($discountAmount)
    {
        if (!is_null($discountAmount) && (strlen($discountAmount) > 13)) {
            throw new \InvalidArgumentException('invalid length for $discountAmount when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 13.');
        }
    ...
    public function setDiscountRate($discountRate)
    {
        if (!is_null($discountRate) && (strlen($discountRate) > 6)) {
            throw new \InvalidArgumentException('invalid length for $discountRate when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 6.');
        }
    ...
    public function setInvoiceNumber($invoiceNumber)
    {
        if (!is_null($invoiceNumber) && (strlen($invoiceNumber) > 23)) {
            throw new \InvalidArgumentException('invalid length for $invoiceNumber when calling InlineResponse2002OrderInformationLineItems., must be smaller than or equal to 23.');
        }
