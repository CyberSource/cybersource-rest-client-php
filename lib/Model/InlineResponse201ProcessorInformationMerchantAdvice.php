...
/**
 * InlineResponse201ProcessorInformationMerchantAdvice Class Doc Comment
 *
 * @category    Class
 * @package     CyberSource
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InlineResponse201ProcessorInformationMerchantAdvice implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inline_response_201_processorInformation_merchantAdvice';
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (strlen($code) > 2)) {
            throw new \InvalidArgumentException('invalid length for $code when calling InlineResponse201ProcessorInformationMerchantAdvice., must be smaller than or equal to 2.');
        }
    ...
    public function setCodeRaw($codeRaw)
    {
        if (!is_null($codeRaw) && (strlen($codeRaw) > 2)) {
            throw new \InvalidArgumentException('invalid length for $codeRaw when calling InlineResponse201ProcessorInformationMerchantAdvice., must be smaller than or equal to 2.');
        }
