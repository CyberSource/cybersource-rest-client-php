...
class Riskv1authenticationsOrderInformationBillTo implements ArrayAccess
{
    ...
    {
        if ((strlen($administrativeArea) > 2)) {
            throw new \InvalidArgumentException('invalid length for $administrativeArea when calling Riskv1authenticationsOrderInformationBillTo., must be smaller than or equal to 2.');
        }
