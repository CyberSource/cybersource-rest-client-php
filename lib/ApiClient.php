...
class ApiClient {
	...
	public function __construct(
		\CyberSource\Configuration $config = null,
		\CyberSource\Authentication\Core\MerchantConfiguration $merchantConfig = null
	) {
		if ($config === null) {
	...
	*/
	public function callAuthenticationHeader($method, $postData, $resourcePath) {
		...
		if ($merchantConfig->getAuthenticationType() == GlobalParameter::HTTP_SIGNATURE) {
			...
			if ($merchantConfig->getAuthenticationType() == GlobalParameter::JWT) {
				$headers = [
		...
		if ($method == GlobalParameter::POST || $method == GlobalParameter::PUT || $method == GlobalParameter::PATCH) {
			...
			$digestArry = [GlobalParameter::POSTHTTPDIGEST.$digest];
	...
	public function dataMasking($postData_json_raw) {
		$toBeMask = [
			"number" => "XXXXX", "expirationMonth" => "XXXXX", "expirationYear" => "XXXX", "email" => "XXXXX",
			"firstName" => "XXXXX", "lastName" => "XXXXX", "phoneNumber" => "XXXXX", "type" => "XXXXX",
			"securityCode" => "XXXXX", "totalAmount" => "XXXXX", "token" => "XXXXX", "signature" => "XXXXX"
		];
