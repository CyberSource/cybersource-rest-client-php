...
class KeymanagementscmpApi
{
     ...
     * @param \CyberSource\Model\UpdatePGPKeysRequest1 $updatePGPKeysRequest  (required)
    ...
    public function updateSCMPWithHttpInfo($keyId, $updatePGPKeysRequest)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSource\Model\UpdatePGPKeysRequest1')), $this->apiClient->merchantConfig->getRunEnvironment());
