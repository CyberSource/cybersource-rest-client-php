...
class PaymentsApi
{
    ...
    public function createPaymentWithHttpInfo($createPaymentRequest)
    {
        ...
        $explode = explode('\\', '\CyberSource\Model\CreatePaymentRequest');
    ...
    public function incrementAuthWithHttpInfo($id, $incrementAuthRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\IncrementAuthRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explode), $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function refreshPaymentStatusWithHttpInfo($id, $refreshPaymentStatusRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\RefreshPaymentStatusRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explode), $this->apiClient->merchantConfig->getRunEnvironment());
