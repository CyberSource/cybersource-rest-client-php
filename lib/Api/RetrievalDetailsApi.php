...
class RetrievalDetailsApi
{
    ...
    public function getRetrievalDetailsWithHttpInfo($startTime, $endTime, $organizationId = null)
    {
        ...
        if (!is_null($organizationId) && (strlen($organizationId) > 32)) {
            self::$logger->error("InvalidArgumentException : Invalid length for \"$organizationId\" when calling RetrievalDetailsApi.getRetrievalDetails, must be smaller than or equal to 32.");
            throw new \InvalidArgumentException('Invalid length for "$organizationId" when calling RetrievalDetailsApi.getRetrievalDetails, must be smaller than or equal to 32.');
        }
        if (!is_null($organizationId) && (strlen($organizationId) < 1)) {
            self::$logger->error("InvalidArgumentException : Invalid length for \"$organizationId\" when calling RetrievalDetailsApi.getRetrievalDetails, must be bigger than or equal to 1.");
            throw new \InvalidArgumentException('Invalid length for "$organizationId" when calling RetrievalDetailsApi.getRetrievalDetails, must be bigger than or equal to 1.');
        }
