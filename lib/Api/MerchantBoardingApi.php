...
class MerchantBoardingApi
{
    ...
    public function postRegistrationWithHttpInfo($postRegistrationBody, $vCIdempotencyId = null)
    {
        ...
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end(explode('\\', '\CyberSource\Model\PostRegistrationBody')), $this->apiClient->merchantConfig->getRunEnvironment());
