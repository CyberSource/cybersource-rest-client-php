...
class ReportSubscriptionsApi
{
    ...
    public function createStandardOrClassicSubscriptionWithHttpInfo($predefinedSubscriptionRequestBean, $organizationId = null)
    {
        ...
        $explode = explode('\\', '\CyberSource\Model\PredefinedSubscriptionRequestBean');
    ...
    public function createSubscriptionWithHttpInfo($createReportSubscriptionRequest, $organizationId = null)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\CreateReportSubscriptionRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explde), $this->apiClient->merchantConfig->getRunEnvironment());
