...
class PayerAuthenticationApi
{
    ...
    public function checkPayerAuthEnrollmentWithHttpInfo($checkPayerAuthEnrollmentRequest)
    {
        ...
        $explode = explode('\\', '\CyberSource\Model\CheckPayerAuthEnrollmentRequest');
    ...
    public function payerAuthSetupWithHttpInfo($payerAuthSetupRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\PayerAuthSetupRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explode), $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function validateAuthenticationResultsWithHttpInfo($validateRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\ValidateRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explode), $this->apiClient->merchantConfig->getRunEnvironment());
