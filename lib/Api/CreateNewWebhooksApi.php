...
class CreateNewWebhooksApi
{
    ...
    public function createWebhookSubscriptionWithHttpInfo($createWebhookRequest = null)
    {
        ...
        if (MLEUtility::checkIsMLEForAPI($this->apiClient->merchantConfig, $isMLESupportedByCybsForApi, "createWebhookSubscription,createWebhookSubscriptionWithHttpInfo")) {
            try {
