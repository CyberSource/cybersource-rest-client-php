...
/**
 * TransactionBatchApi Class Doc Comment
 *
 * @category Class
 * @package  CyberSource
 * @author   Swagger Codegen team
...
class TransactionBatchApi
{
    ...
    /**
     * Operation ptsV1TransactionBatchesIdGet
     *
     ...
     * @return void
     */
    public function ptsV1TransactionBatchesIdGet($id)
    {
        list($response, $statusCode, $httpHeader) = $this->ptsV1TransactionBatchesIdGetWithHttpInfo($id);
        return [$response, $statusCode, $httpHeader];
    }

    /**
     * Operation ptsV1TransactionBatchesIdGetWithHttpInfo
     *
     * Get an individual batch file Details processed through the Offline Transaction Submission Services
     *
     * @param string $id The batch id assigned for the template. (required)
     ...
     */
    public function ptsV1TransactionBatchesIdGetWithHttpInfo($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling ptsV1TransactionBatchesIdGet');
        }
        // parse inputs
