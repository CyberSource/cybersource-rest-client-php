...
class ConversionDetailsApi
{
    ...
    public function getConversionDetailWithHttpInfo($startTime, $endTime, $organizationId = null)
    {
        ...
        if (!is_null($organizationId) && (strlen($organizationId) > 32)) {
            self::$logger->error("InvalidArgumentException : Invalid length for \"$organizationId\" when calling ConversionDetailsApi.getConversionDetail, must be smaller than or equal to 32.");
        ...
        if (!is_null($organizationId) && (strlen($organizationId) < 1)) {
            self::$logger->error("InvalidArgumentException : Invalid length for \"$organizationId\" when calling ConversionDetailsApi.getConversionDetail, must be bigger than or equal to 1.");
