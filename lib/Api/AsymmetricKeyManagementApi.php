...
class AsymmetricKeyManagementApi
{
    ...
    public function createP12KeysWithHttpInfo($createP12KeysRequest)
    {
        ...
        $explode = explode('\\', '\CyberSource\Model\CreateP12KeysRequest');
    ...
    public function deleteBulkP12KeysWithHttpInfo($deleteBulkP12KeysRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\DeleteBulkP12KeysRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explode), $this->apiClient->merchantConfig->getRunEnvironment());
    ...
    public function updateAsymKeyWithHttpInfo($keyId, $updateAsymKeysRequest)
    {
        ...
        $sdkTracker = new \CyberSource\Utilities\Tracking\SdkTracker();
        $explode = explode('\\', '\CyberSource\Model\UpdateAsymKeysRequest');
        $_tempBody = $sdkTracker->insertDeveloperIdTracker($_tempBody, end($explode), $this->apiClient->merchantConfig->getRunEnvironment());
